...
import { deleteImage } from "../../utils/img.util";
import path from "node:path";
import { zodValidation } from "../../validation/utils/zodValidation";
import {
  createCourseSchema,
  updateCourseSchema,
} from "../../validation/schemas/course.schemas";
...
class CourseController {
  ...
  createCourse(
    ...
    const defaultImagePath =
      "/images/42453009_1107123126122822_5845019373923729408_n.png";
    const image = req.file ? `/images/${req.file.filename}` : defaultImagePath;
  ...
  async updateCourse(
    ...
    const updatedCourse = courseService.updateCourse(id, {
      ...(validData as UpdateCourseDTO),
      image,
    });
