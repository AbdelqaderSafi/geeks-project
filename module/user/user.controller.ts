...
class UserController {
  ...
  async createCoach(
    req: Request<BodyObject, BodyObject, CreateCoachDTO>,
    res: Response
  ) {
    ...
    const newUser: Omit<IUser, keyof IBaseData | "role"> = {
      ...validData,
      password: hashedPass,
    };
  ...
  updateCurrentUser(
    ...
    const updatedUser = userService.updateUser(id, validData as Partial<IUser>);
